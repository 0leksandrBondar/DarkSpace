...
void Client::setUsername(const QString& newUsername) { _username = newUsername; }
...
void Client::processingClientDataFromServer(ClientDataType type)
{
    ...
    case ClientDataType::MessageType:
    {
        ...
        emit getMessageFromServer(_dataFromServer.textMessageData().first,
                                  _dataFromServer.userName());
        break;
    }
...
QString Client::userName() const { return _username; }
...
void Client::setReceiver(const QString& receiver) { _receiver = receiver; }
